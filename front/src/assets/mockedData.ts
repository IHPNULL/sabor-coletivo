...
export const recipe1: RecipeType = {
  ...
  steps:
    "Primeiro, bata bem os ovos no liquidificador.            Acrescente o leite condensado e o leite, e bata novamente.            Calda: Derreta o açúcar na panela até ficar moreno, acrescente a água e deixe engrossar. Coloque em uma forma redonda e despeje a massa do pudim por cima.    Asse em forno médio por 45 minutos, com a assadeira redonda dentro de uma maior com água.   Espete um garfo para ver se está bem assado.",
  calories: 240,
  portion: 50,
  protein: 3,
  carbs: 25,
...
export const recipe4: RecipeType = {
  ...
  steps:
    "Em uma tigela grande, coloque a carne, o cheiro-verde, a cebola, o ovo e o sal, e amasse bem com as mãos até que fique homogêneo,Divida em 6 partes iguais e modele cada uma delas no formato de hambúrguer,Em uma frigideira grande, coloque 1 colher (sopa) de óleo e leve ao fogo médio para aquecer. Frite os hambúrgueres, aos poucos, por 3 minutos de cada lado, ou até que dourem, repondo o óleo quando necessário,Distribua uma fatia de queijo por cima de cada hambúrguer e tampe a frigideira para derreter o queijo,Passe a maionese HELLMANN´S pela superfície interna das fatias de pão. Leve-as à mesma frigideira pré-aquecida com o lado da maionese virado para baixo e deixe tostar em fogo baixo por 2 minutos,Distribua os hambúrgueres sob as metades das fatias de pão e, por cima, coloque as folhas de alface e as rodelas de tomate,Espalhe a maionese HELLMANN´S e finalize com as outras partes dos pães e sirva em seguida",
  calories: 225,
  portion: 76,
  protein: 10,
  carbs: 5,
...
export const recipe6: RecipeType = {
  ...
  steps:
    "Numa tigela pequena quebre o ovo, com cuidado para não furar a gema,Leve uma frigideira antiaderente ao fogo baixo e regue com 1 colher (chá) de azeite. Com cuidado, transfira o ovo para a frigideira e deixe cozinhar por cerca de 2 minutos – com uma espátula de silicone, vá puxando a borda da clara para perto da gema, para manter o formato arredondado do ovo,Assim que a clara começar a firmar, tempere com sal e pimenta a gosto e tampe a frigideira para o ovo terminar de fritar mas a gema ainda ficar mole – o vapor permite que a clara cozinhe por igual sem a base do ovo queimar. Sirva a seguir.",
  calories: 50,
  portion: 20,
  protein: 2,
  carbs: 15,
